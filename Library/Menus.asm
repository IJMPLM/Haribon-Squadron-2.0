; -------------------------------------------------------
; This file contains the main menu functions,
; including the opening screen, main menu, instructions
...
; ----------------------------------------------
; Print the opening screen, handle user choices
; ----------------------------------------------
proc PrintOpening 
@@printOpening:
...
; Printing information on a table.
